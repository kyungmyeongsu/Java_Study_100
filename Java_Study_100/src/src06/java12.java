...
class Villain1 extends Person3 {
	// Field
...
public class java12 {
	...
	public static void main(String[] args) {
		...
		// [1] : 객체 생성
		Villain1 v1 = new Villain1( "좀비", 20, 180, 80, "15001231", 1, 99.5 );
		v1.printPerson();
		System.out.print( v1.getName() + " " );
		v1.move();  // 부모 클래스의 move() 메서드를 호출.
		
		// [2] : 객체 생성
		Villain1 v2 = new Villain1( "도깨비", 30, 175, 70, "11001121", 1, 77.5 );
		v2.printPerson();
