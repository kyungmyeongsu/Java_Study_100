...
public class java04 {
	...
	/*public static void main2(String[] test) { // args으로 대부분 사용하지만 test로 변경하여도 문제가 되지 않는다.
		System.out.println("Hello World!!");
	}
	오류: src01.java04 클래스에서 기본 메소드를 찾을 수 없습니다. 다음 형식으로 기본 메소드를 정의하십시오.
	   public static void main(String[] args)
	또는 JavaFX 애플리케이션 클래스는 javafx.application.Application을(를) 확장해야 합니다.

	*/
	public static void main(String[] test) { // args으로 대부분 사용하지만 test로 변경하여도 문제가 되지 않는다.
		System.out.println("Hello World!!");
	}
...
(2)파라미터스 --> 메서드(함수) 호출시 하나 or 둘 이상의 파리미터 값을 넣어서 호출할 수 있음.
